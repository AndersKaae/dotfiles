...
-- Set the shortcuts for nvim-tree
...
-- Enable core treesitter highlighting for filetypes whose parser ships with Neovim
-- (c, lua, vim, vimdoc, query, markdown, markdown_inline). No-op otherwise.
vim.api.nvim_create_autocmd("FileType", {
	desc = "Start core treesitter highlighting when a parser is available",
			...
			require("telescope").setup({
				defaults = {
					vimgrep_arguments = {
						...
						"--no-ignore", -- <<< disable .gitignore and friends
					},
				},
